	...
	<div class="container">
		...
		<div class="row PT10 PB10 bgfff">
			...
			<div class="col-xs-9">
				...
				<a href="http://<?php echo ($data["logistics_phone"]); ?>" class="goods-kf">|&nbsp;&nbsp;联系客服</a>
			</div>
		</div>
        ...
        <div class="row bgfff">
            <div class="goods-ddh">
                <div class="col-xs-12 PR0">
                    ...
                    <span class="x-money"><?php echo ($data["money"]); ?> 元</span>
                </div>
            </div>
        </div>
        <div class="row PT10 com-ce"></div>
        ...
        <div class="row bgfff">
            <div class="goods-ddh">
                <div class="col-xs-12 PR0">
                    ...
                    <span class="x-money "><?php echo ($data["order_cash"]); ?> 元</span>
                </div>
            </div>
        </div>
        <div class="row PT10 com-ce"></div>
		<div class="row bgfff" style="border-bottom: 1px solid #e9e9e9;">
			<div class="col-xs-12 PR0">
				<div class="goods-ddh fs-16">
					<span class="fl c-6c6c6c">物流信息</span><span class="x-money">添加物流信息</span>
				</div>
		...
		<div class="row">
			<a href="http://abc" class="goods-sd center-block MT15 MB20">确认送达</a>
		</div>
	</div>
	</body>
</html>