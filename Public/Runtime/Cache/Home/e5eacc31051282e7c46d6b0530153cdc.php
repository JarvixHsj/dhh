	...
	<div class="container">
		...
		<div class="row PT10 PB10 bgfff">
			<div class="col-xs-3 goods-logo PR0">
				<img src="./Public/<?php echo ($data["logistics_img"]); ?>" title="1233"  class="img-responsive img-circle"/>
			</div>
			<div class="col-xs-9">
				<p class="MT5 MB0 fs-16"><?php echo ($data["logistics_name"]); ?></p>
				<a href="#" class="goods-kf">|&nbsp;&nbsp;联系客服</a>
			</div>
		</div>
		...
		<div class="row bgfff">
			<div class="col-xs-12">
				...
				<ul class="dhh-carli MT5" style="border: none;">
					<li class="car-lx">路线：<?php echo ($data["wire_state"]); ?>--<?php echo ($data["wire_end"]); ?></li>
					<li class="car-zz">载重：<?php echo ($data["order_weight"]); ?></li>
					<li class="car-hx">种类：<?php echo ($data["order_cargo_name"]); ?></li>
					<li class="car-tj">体积：<?php echo ($data["order_bulk"]); ?><sup>3</sup></li>
				</ul>
			</div>
		</div>
		<div class="row PT10 com-ce"></div>		
		<div class="row bgfff">
			<div class="col-xs-12 PR0">
				...
				<div class="goods-ddh">
					...
					<span class="fl c-b3b3b3"><?php echo ($data["order_depart_details"]); ?></span>
				</div>
				<div class="goods-ddh" style="border: none;">
					<span class="fl goods-zd">终点</span>	
					<span class="fl c-b3b3b3"><?php echo ($data["order_des_details"]); ?></span>
				</div>
			</div>
		</div>
		<div class="row PT10 com-ce"></div>		
		<div class="row bgfff" style="border-bottom: 1px solid #e9e9e9;">
			<div class="col-xs-12 PR0">
				...
				<!--<p class="c-f6623a MT10 MB10">物流公司尚未上货</p>-->
				<table class="goods-wllist">
					...
					<!--<tr>-->
						<!--<td class="col-xs-1 goods-tdl PT15" valign="top"><img src="/myworks/dhh/www/Public/Home/img/icon13.png" width="30%" height="30%" class="img-responsive center-block"/></td>-->
						<!--<td class="col-xs-11 goods-tdr PT15">-->
							<!--<p class="MB0">【广州市】货车已进入107国道</p>-->
							<!--<p>2015-09-09 09:30</p>-->
						<!--</td>-->
					<!--</tr>-->
					<!--<tr>-->
						<!--<td class="col-xs-1 goods-tdl PT15" valign="top"><img src="/myworks/dhh/www/Public/Home/img/icon14.png" width="30%" height="30%" class="img-responsive center-block"/></td>-->
						<!--<td class="col-xs-11 goods-tdr PT15" style="border:none">-->
							<!--<p class="MB0">【上海市】货物已进入上海市</p>-->
							<!--<p>2015-09-09 09:30</p>-->
						<!--</td>-->
					<!--</tr>-->
				</table>
		...
		<div class="row">
			<button class="goods-sd center-block MT15 MB20">确认送达</button>
		</div>
	</div>
	</body>
</html>