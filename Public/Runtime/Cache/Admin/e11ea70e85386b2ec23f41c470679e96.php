...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/myworks/dhh/www/Public/Admin/css/login.css" media="all">
        <link rel="stylesheet" type="text/css" href="/myworks/dhh/www/Public/Admin/css/default_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><?php echo C('SITE_TITLE');?>管理平台</h3>
