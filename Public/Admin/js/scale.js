(function(window, undefined){
	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			$(".imgzoom_pack div").click(function(){
			...
			$(".imgzoom_img img").on("tap",function(){
				zoomMask.style.cssText = "display:none";
			});
...
////				if(self.distX == 0 && self.distY == 0){
////	                document.querySelector(".imgzoom_pack").style.cssText = "display:none";
////					zoomImg.src = "";
////					zoomImg.style.cssText = "";
////	
////					self._destroy();
