...
<link rel="stylesheet" type="text/css" href="/myworks/dhh/www/Public/Admin/css/common.css" media="all">
    ...
    /*左边导航样式*/
    .nlist li a{ display:block; line-height:22px; height:22px; padding-left:22px; background:url(/myworks/dhh/www/Public/Admin/images/nav_icon.gif) no-repeat 5px top; border:1px solid #fff; margin:3px 2px 0 2px; color:#333; text-decoration:none; }
    .nlist li a:hover{ border:1px solid #eae8e8; background:url(/myworks/dhh/www/Public/Admin/images/nav_icon.gif) no-repeat 5px -22px #f5f5f5; }
    .nlist li.title{ margin-top:5px; line-height:25px; font-weight:600; color:#090; padding-left:25px; background:url(/myworks/dhh/www/Public/Admin/images/nav_icon.gif) no-repeat 7px -50px;}
