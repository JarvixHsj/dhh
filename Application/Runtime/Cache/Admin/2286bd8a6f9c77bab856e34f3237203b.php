...
<form action="<?php echo U(CONTROLLER_NAME.'/update');?>" method="post">
    <br />
    物流公司：
    ...
    <br/>
    轻货价格：<input type="text" placeholder="例如：200-300元" name="gently" value="<?php echo ($row['gently']); ?>">
    <br/>
    <br/>
    重货价格：<input type="text" placeholder="例如：200-300元" name="price" value="<?php echo ($row['price']); ?>">
    <br/>
    <br/>
    花费时间：<input type="text" name="predict_time" placeholder="例如：1天  或者  2-3天" value="<?php echo ($row['predict_time']); ?>">
    <br/>
    <br/>
    <input type="hidden" name="rela_id" value="<?php echo ($row['rela_id']); ?>">
