...
var form_search_fields = [
    { display: "id", name: "wire_id", newline: true, type: "text"},
    { display: "起点", name: "wire_state", newline: true, type: "text"},
    { display: "终点", name: "wire_end", newline: true, type: 'text'},
];

var grid_columns  = [
    { display: 'ID', name: 'wire_id', width: 80, frozen: true},
    { display: '起点', name: 'state.region_name', minWidth: 100, width: 80, isSort: false },
    { display: '终点', name: 'end.region_name', minWidth: 100, width: 100, isSort: false },
    { display: '轻货价格', name: 'gently', minWidth: 100, width: 100, isSort: false },
    { display: '重货价格', name: 'weighty', minWidth: 100, width: 100, isSort: false },
    { display: '路线状态', name: 'wire_effect', width: 100, isSort: false ,
...
function toggle_status(id, effect) {
    var url = "<?php echo U('CarWire/toggleStatus');?>";
