...
<script>
    var ligerFormFields = [
        { display: "ID", name: "user_id", newline: true, type: "text", readonly: 'true' },
        { display: "用户名", name: "user_name", newline: true, type: "text"},
        { display: "用户手机", name: "user_phone", newline: true, type: "text",readonly: 'true', validate: { required: true}},
        { display: "用户年龄", name: "user_age", newline: true, type: "text"},
        { display: "用户性别", name: "user_sex", newline: true, type: "select",
            options: {
        ...
        { display: "用户图片", name: "user_img", comboboxName: "user_img", newline: true, type: "select",
            options: {
                cancelable: false,
                url_upload: '<?php echo U(CONTROLLER_NAME.'/img_upload');?>'
            }
        },
        { display: "唯一口令", name: "token", newline: true, type: "text",readonly: 'true' },
        { display: "状态", name: "user_status", newline: true, type: "select", validate: { required: true},
            options: {
