	...
	<div class="container">
		...
		<div class="row bgfff">
			<div class="col-xs-12 PR0">
				<div class="goods-ddh fs-16">
					<center>
					<span style="color:#F88C70;font-weight:bold;font-size:13px">订单已完成</span>
					</center>
				</div>
			</div>
		</div>
		<div class="row href">
			<?php if($data["if_comm"] == 1): ?><button class="goods-sd center-block MT15 MB20" style="background: #CECECE">已评论</button >
			<?php else: ?>
				<a href="http://192.168.1.2" class="goods-sd center-block MT15 MB20" onclick="clickcomment()">评论</a><?php endif; ?>
		</div>
	</div>
	</body>
