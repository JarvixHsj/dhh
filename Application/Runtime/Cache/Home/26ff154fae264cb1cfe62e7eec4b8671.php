...
<body class="bgf3f3f3">
	<div class="container">
        ...
        <div class="row bgfff">
            <div class="goods-ddh">
                <div class="col-xs-12 PR0">
                    ...
                    <span class="x-money"><?php if($data[money] == ''): ?>0<?php else: echo ($data["money"]); endif; ?> 元</span>
                </div>
            </div>
        </div>
        <div class="row PT10 com-ce"></div>
        ...
        <!--<div class="row bgfff">-->
            <!--<div class="goods-ddh">-->
                <!--<div class="col-xs-12 PR0">-->
                    <!--<span class="fl goods-cxbzj">诚信保证金</span>-->
                    <!--<span class="x-money "><?php if('' == $data.order_cash): ?>0<?php else: echo ($data["order_cash"]); endif; ?> 元</span>-->
                <!--</div>-->
            <!--</div>-->
        <!--</div>-->

		<?php if($data['order_is_goods'] == 1): ?><div class="row bgfff">
			<div class="goods-ddh">
				<div class="col-xs-12 PR0">
					<span class="fl">物流信息</span>
					<span class="x-money " ><a href="http://192.168.1.33" onclick="addinfo()" style="color:#F7623A;">添加物流信息</span>
				</div>
			</div>
		</div><?php endif; ?>
        <div class="row PT10 com-ce"></div>

		<?php if($data["track"] == ''): else: ?>
		...
		<div class="row href">
			<a href="http://192.168.1.30" class="goods-sd center-block MT15 MB20" onclick="huozhu()">联系货主</a>
			<?php if($data[order_is_goods] == 1): ?><a href="http://192.168.1.31" class="goods-sd center-block MT15 MB20" onclick="songda()" style="background:#E46465;">确认送达</a>
			<?php else: ?>
				<a href="http://192.168.1.32" class="goods-sd center-block MT15 MB20" onclick="shanghuo()" style="background:#E46465;">确认上货</a><?php endif; ?>
